    ...
    <div class="flex">
        ...
        <div class="bg-white shadow-xl rounded-lg overflow-hidden">
            ...
            <div class="p-6 space-y-4">
                ...
                <form action="?/updateLocation" method="POST" class="bg-white border border-gray shadow-md rounded-lg p-4 mb-2">
                    ...
                    <div class="flex lg:justify-center justify-end pt-2">
                        <button type="submit" class="bg-blue-500 text-white rounded mx-2 py-2 px-4 hover:bg-blue-700">Update</button>
                        
                        <form action="?/deleteLocation&id={location.id}" method="POST">
                            <button type="submit" class="bg-red-500 text-white rounded mx-2 py-2 px-4 hover:bg-red-700">Delete</button>
                        </form>
                    </div>
                </form>
            {:else}
